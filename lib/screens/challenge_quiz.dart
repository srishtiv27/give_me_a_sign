...
class ChallengeQuiz extends StatefulWidget {
  static String id = 'challenge_quiz';
  @override
...
class _ChallengeQuizState extends State<ChallengeQuiz> {
  ...
  Button button1 = Button(
      label: quizBrain.challengeOption1[quizBrain.questionNumber],
      color: Color(0xFF42436B));
  Button button2 = Button(
      label: quizBrain.challengeOption2[quizBrain.questionNumber],
      color: Color(0xFF42436B));
  Button button3 = Button(
      label: quizBrain.challengeOption3[quizBrain.questionNumber],
      color: Color(0xFF42436B));

  void checkAnswer(Button button) {
    String userPickedAnswer = button.label;
    String correctAnswer =
        quizBrain.getCorrectAnswer(quizBrain.challengeQuestionBank);
    setState(() {
          ...
          children: <Widget>[
            ...
            Center(
              child: ClipRRect(
                ...
                child: Image.asset(
                  quizBrain.getQuestionImage(quizBrain.challengeQuestionBank),
                  height: 275,
                ),
              ),
            ),
            ...
            FlatButton(
              ...
              onPressed: () {
                setState(() {
                  if (quizBrain.isFinished(quizBrain.challengeQuestionBank)) {
                    Alert(
                      closeFunction: () {
                      ...
                      title: 'Finished!',
                      desc:
                          'You\'ve reached the end of the quiz. Your score was $scoreKeeper out of ${quizBrain.challengeQuestionBank.length}',
                    ).show();
                    quizBrain.reset();
                    scoreKeeper = 0;
                  }
                  ...
                  button1.label =
                      quizBrain.challengeOption1[quizBrain.questionNumber];
                  button2.label =
                      quizBrain.challengeOption2[quizBrain.questionNumber];
                  button3.label =
                      quizBrain.challengeOption3[quizBrain.questionNumber];
                });
              },
            ),
          ],
